...
package com.derpquest.settings.etc;
...
public class AccentColorPreferenceController extends AbstractPreferenceController implements
    ...
    static final int DEFAULT_ACCENT_COLOR = 0x0086FA;
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        String hexColor = String.format("#%08x", (0x0086FA & intColor));
        if (hexColor.equals("#0086fa")) {
        ...
        if (hexColor.equals("#0086fa"))
            mAccentColor.setCustomColorPreview(mContext.getResources()
                    .getColor(R.color.derp_default_accent_color));
    }
